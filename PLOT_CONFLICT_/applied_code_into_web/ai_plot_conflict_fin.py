...
def ai_plot_conf(essay_input_):
    ...
    result_all_avg = 3.4  ####### 평균 계산법
    
    result_emotional_rollwercoaster =  1
    result_plot_complexity = 1
    result_degree_conflict = 1
...
def ai_plot_coflict_total_analysis(input_text):
    ...
    ## 1000명 데이터의 각 값(char_desc_mean)의 평균 값 전달.
    plot_conflict_all_mean = [77, 478, 14]
    ...
    overall_character_rating = [(fin_result[0][1]+ fin_result[1][1] + fin_result[2][1])/3]
