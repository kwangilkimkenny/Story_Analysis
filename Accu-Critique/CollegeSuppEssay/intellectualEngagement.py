...
def getCoherenceLevel(essay_input): 
    ...
    return coherence, academic_verbs_ratio
...
get_coherence_level = getCoherenceLevel(essay_input)
print('Result of Coherence Level:', get_coherence_level)
