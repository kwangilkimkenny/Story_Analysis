...
def get_achievement_you_are_proud_of(essay_input):
...
pmt_ori_key_re = get_achievement_you_are_proud_of(essay_input)
...
print('Achievement you are proud of _ initiative_enguagement 관련 단어가 에세이에 포함된 비율 :', pmt_ori_key_re[3])
print('Achievement you are proud of _ initiative_enguagement가 합격생 평균에 비교하여 얻은 최종 값 :', pmt_ori_key_re[4])


### 결과 ###
# Achievement you are proud of _ Prompt Oriented Keywords 값 계산 결과: Supurb
# Achievement you are proud of _ Prompt Oriented Keywords - 입력에세이의 토픽과 비교할 단어가 얼마나 일치하는지에 대한 비율 계산 결과 : 14.71
# Achievement you are proud of _ Prompt Oriented Keywords 단어들(웹사이트에 표시) : ['able', 'high', 'ambition', 'help', 'career']
# Achievement you are proud of _ initiative_enguagement 관련 단어가 에세이에 포함된 비율 : 7.531
# Achievement you are proud of _ initiative_enguagement가 합격생 평균에 비교하여 얻은 최종 값 : Strong