...
def SummerActivity(essay_input):
    ...
    # 추출한 값의 중복값 제거
    if get_score__ != None: # null 값이 아닐경우 이하 내용 계산
...
def summer_act_majorfit(essay_input):
    ...
    data = {
        ...
        'Name of Popular Summer Programs' : get_score_fin, # 에세이서 발견한 썸머활동관련 전공
        'Major Summer Programs score' : result_score # 추출한 활동내역을 점수로 변환 --------> overall 값 계산에 적용할 것
    }
...
print('Major Fit: ', summer_act_majorfit(essay_input))