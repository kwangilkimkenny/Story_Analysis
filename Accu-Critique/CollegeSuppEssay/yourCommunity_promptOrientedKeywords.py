# 1)  your community Prompt Oriented Keywords
# 관련 주제의 단어들과 에세이의 다른 key topic들이 가까이 있는지 아닌지
...
### 결과 ###
# your community role and contribution in your community _ Prompt Oriented Keywords 값 계산 결과: Mediocre
# your community role and contribution in your community _ Prompt Oriented Keywords - 입력에세이의 토픽과 비교할 단어가 얼마나 일치하는지에 대한 비율 계산 결과 : 52.94
# your community role and contribution in your community _ Prompt Oriented Keywords 단어들(웹사이트에 표시) : ['year', 'opportunity', 'career', 'able', 'research', 'cancer', 'data', 'microscopy', 'high', 'place', 'image', 'school', 'role', 'write', 'possible', 'significant', 'death', 'help']
# your community role and contribution in your community _ 관련 단어가 에세이에 포함된 비율 : 7.531
# your community role and contribution in your community _ 합격생 평균에 비교하여 얻은 최종 값 : Strong
