...
def social_awareness_analysis(essay_input):
    ...
    verbs_list = data_ac_verbs_list + activism
...
#         ext_sim_words_key = df_r.values.tolist() # 유사단어 추출
    ...
    return action_verbs_ratio, ext_words
