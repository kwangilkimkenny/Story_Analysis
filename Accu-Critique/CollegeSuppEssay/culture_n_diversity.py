...
# # 입력값:  대학, 전공 ex) ('Intellectual interest', 'Brown', 'Brown_African Studies_dept', 'African Studies', essay_input)
# print("sentiments_anaysis:", pmpt_orinted_sentments('Culture & diversity', 'Brown', 'Brown_African Studies_dept', 'African Studies', essay_input))
...
def engagement(essay_input):
    ...
    return engagement_re_final, Engagement_result[2], engagement_words_list
...
def topic_anaysis(prompt_type, essay_input):
    ...
    data = {
        ...
        'google_search__all_result' : google_search__all_result, 
        ...
        'tp_kwlg_result' : tp_kwlg_result, 
        'result_pmpt_ori[0]': result_pmpt_ori[0], # 0. topic_ext_result : Supurb ~ Lacking
        'esult_pmpt_ori[1] ': result_pmpt_ori[1], # 1. topic_score : numeric number
...
### 최종 실행파일 ### !!!!!!!
# 입력값:  대학, 전공 ex) ('Intellectual interest', 'Brown', 'Brown_African Studies_dept', 'African Studies', essay_input)
def culture_diversity_analysis(prompt_type, select_college, select_college_dept, select_major, essay_input):
    ...
    # 문장생성
    fixed_top_comment = """Culture and diversity may involve various elements in your life, and your understanding of such variety is essential. Meanwhile, you should be able to demonstrate how you uniquely define your own culture and diversity, ultimately, to explain how you are engaged both mentally and physically."""

    def gen_comment(input_score, type):
        if input_score == 'Supurb' or input_score == 'Strong':
            if type == 'prompt_ori_keywords':
                comment_achieve = """It seems that your essay successfully deals with the concepts of culture and diversity."""
            elif type == 'prompt_ori_sentiment':
                comment_achieve = """Also, it is clear that you are emotionally engaged with this particular issue, and"""
            elif type == 'engagement':
                comment_achieve = """your story seems to demonstrate a high level of effort and contribution."""
            ...
            if type == 'prompt_ori_keywords':
                comment_achieve = """It seems that your essay sufficiently deals with the concepts of culture and diversity."""
            elif type == 'prompt_ori_sentiment':
                comment_achieve = """Also, you seem to be emotionally engaged with this particular issue, and"""
            elif type == 'engagement':
                comment_achieve = """your story seems to demonstrate a satisfactory level of effort and contribution."""
            elif type == 'topic_uniqueness':
            ...
            if type == 'prompt_ori_keywords':
                comment_achieve = """It seems that your essay is lacking the concepts of culture and diversity."""
            elif type == 'prompt_ori_sentiment':
                comment_achieve = """your story seems to be lacking the elements of effort and contribution."""
            elif type == 'engagement':
                comment_achieve = """Also, your emotional engagement with this particular issue is somewhat weak, while"""
            elif type == 'topic_uniqueness':
                comment_achieve = """The topics in your essay seem somewhat familiar. Hence, you may consider finding less generic topics while adding more detail."""
            elif type == 'topic_knowledge':
                comment_achieve = """n terms of your knowledge of the topic, you may need to include more details."""
            else:
                pass
...
print(culture_diversity_analysis(prompt_type, 'Brown', 'Brown_African Studies_dept', 'African Studies', essay_input))
