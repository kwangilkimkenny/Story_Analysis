...
def selected_college(select_pmt_type, select_college, select_college_dept, select_major, coll_supp_essay_input_data):
    ...
    data_result = {
        ...
        # summer activity
        'overall_summer_actibity' : overall_summer_actibity, # summer actibity overall score!
        ...
        # 문장생성
        'fixed_comment_summerActivity' : fixed_comment_summerActivity, # 고정문장 생성
...
# summeractivtiy 의 값이 포함되어있을 경우의 에세이
