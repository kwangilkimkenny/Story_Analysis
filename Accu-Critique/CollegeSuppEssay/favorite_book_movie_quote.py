...
def favorite_book_movie_quote(prompt_type, select_college, select_college_dept, select_major, essay_input):
    ...
    # overall score
    overallScore = round(topic_score_numeric * 5.4 + prompt_ori_sentiments_result_numeric_score * 0.15 + topic_uniqueness_numeric_score * 0.25 + PS_re * 0.25)
    overallScore_5div = calculate_score(overallScore)


# 문장생성
    fixed_top_comment = """A good essay on one’s favorite book, movie, or quote should be more than just a synopsis. Beyond your knowledge about the subject, you should convey your emotions and opinion towards the topics and main idea of the story. It will highlight your distinct taste if the book, movie, or quote you have chosen is a unique one."""
    def gen_comment(input_score, type):
        if input_score == 'Supurb' or input_score == 'Strong':
            if type == 'topic_knowledge':
                comment_achieve = """It seems that you have an extensive knowledge on the content of the work you’ve chosen, and"""
            elif type == 'prompt_ori_sentiment':
                comment_achieve = """the sentiments show that you’ve thoroughly enjoyed it."""
            elif type == 'topic_uniqueness':
                comment_achieve = """The work you’ve chosen seems quite unique, and it shows your distinct taste."""
            elif type == 'perspective':
                comment_achieve = """In general, your thoughts and ideas seem very clearly stated."""
            else:
                pass
        elif input_score == 'Good':
            if type == 'topic_knowledge':
                comment_achieve = """It seems that you have a good grasp on the content of the work you’ve chosen, and"""
            elif type == 'prompt_ori_sentiment':
                comment_achieve = """the sentiments show that you’ve enjoyed it."""
            elif type == 'topic_uniqueness':
                comment_achieve = """The work you’ve chosen seems somewhat unique, but you may consider searching for less popular topics."""
            elif type == 'perspective':
                comment_achieve = """In general, your thoughts and ideas seem clear enough."""
            else:
                pass
        else: #input score == 'Mediocre' or input_score == 'Weak'
            if type == 'topic_knowledge':
                comment_achieve = """It seems that you may need to include more details on the work you’ve chosen, and"""
            elif type == 'prompt_ori_sentiment':
                comment_achieve = """adding more positive emotions may improve the essay."""
            elif type == 'topic_uniqueness':
                comment_achieve = """The work you’ve chosen seems a popular one and you may want to consider selecting a more unique subject."""
            elif type == 'perspective':
                comment_achieve = """In general, your thoughts and ideas seem a bit obscure."""
            else:
                pass
        return comment_achieve

    comment_1 = gen_comment(topic_knowledge_5div_re, 'topic_knowledge')
    comment_2 = gen_comment(prompt_ori_sentiments_result_5div, 'prompt_ori_sentiment')
    comment_3 = gen_comment(topic_uniqueness_fin_re, 'topic_uniqueness')
    comment_4 = gen_comment(topic_uniqueness_fin_re, 'perspective')
    ...
    data = {
        ...
        'overallScore_5div' : overallScore_5div,
        ...
        'PS_5Div_score' : PS_5Div_score, # perspective Supurb ~ Lacking
...
print('favorite__result :' , favorite_book_movie_quote("Favorite book/movie/quote", "Brown", "Brown_African Studies_dept", "African Studies", essay_input))